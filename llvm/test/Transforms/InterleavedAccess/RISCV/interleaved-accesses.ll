...
; RV32-NEXT:    [[TMP1:%.*]] = call target("riscv_vec_tuple", <vscale x 32 x i8>, 2) @llvm.riscv.vlseg2.triscv_vec_tuple_nxv32i8_2t.i32(target("riscv_vec_tuple", <vscale x 32 x i8>, 2) poison, ptr [[PTR:%.*]], i32 -1, i32 5)
; RV32-NEXT:    [[TMP2:%.*]] = call <vscale x 8 x i32> @llvm.riscv.vector.extract.nxv8i32.triscv_vec_tuple_nxv32i8_2t.i32(target("riscv_vec_tuple", <vscale x 32 x i8>, 2) [[TMP1]], i32 0)
; RV32-NEXT:    [[TMP3:%.*]] = insertvalue { <vscale x 8 x i32>, <vscale x 8 x i32> } poison, <vscale x 8 x i32> [[TMP2]], 0
; RV32-NEXT:    [[TMP4:%.*]] = call <vscale x 8 x i32> @llvm.riscv.vector.extract.nxv8i32.triscv_vec_tuple_nxv32i8_2t.i32(target("riscv_vec_tuple", <vscale x 32 x i8>, 2) [[TMP1]], i32 1)
; RV32-NEXT:    [[TMP5:%.*]] = insertvalue { <vscale x 8 x i32>, <vscale x 8 x i32> } [[TMP3]], <vscale x 8 x i32> [[TMP4]], 1
; RV32-NEXT:    ret void
;
; RV64-LABEL: @load_factor2_vscale(
; RV64-NEXT:    [[TMP1:%.*]] = call target("riscv_vec_tuple", <vscale x 32 x i8>, 2) @llvm.riscv.vlseg2.triscv_vec_tuple_nxv32i8_2t.i64(target("riscv_vec_tuple", <vscale x 32 x i8>, 2) poison, ptr [[PTR:%.*]], i64 -1, i64 5)
; RV64-NEXT:    [[TMP2:%.*]] = call <vscale x 8 x i32> @llvm.riscv.vector.extract.nxv8i32.triscv_vec_tuple_nxv32i8_2t.i64(target("riscv_vec_tuple", <vscale x 32 x i8>, 2) [[TMP1]], i64 0)
; RV64-NEXT:    [[TMP3:%.*]] = insertvalue { <vscale x 8 x i32>, <vscale x 8 x i32> } poison, <vscale x 8 x i32> [[TMP2]], 0
; RV64-NEXT:    [[TMP4:%.*]] = call <vscale x 8 x i32> @llvm.riscv.vector.extract.nxv8i32.triscv_vec_tuple_nxv32i8_2t.i64(target("riscv_vec_tuple", <vscale x 32 x i8>, 2) [[TMP1]], i64 1)
...
; RV32-NEXT:    [[TMP1:%.*]] = call target("riscv_vec_tuple", <vscale x 8 x i8>, 2) @llvm.riscv.vector.insert.triscv_vec_tuple_nxv8i8_2t.nxv8i8.i32(target("riscv_vec_tuple", <vscale x 8 x i8>, 2) poison, <vscale x 8 x i8> [[V0:%.*]], i32 0)
; RV32-NEXT:    [[TMP2:%.*]] = call target("riscv_vec_tuple", <vscale x 8 x i8>, 2) @llvm.riscv.vector.insert.triscv_vec_tuple_nxv8i8_2t.nxv8i8.i32(target("riscv_vec_tuple", <vscale x 8 x i8>, 2) [[TMP1]], <vscale x 8 x i8> [[V1:%.*]], i32 1)
; RV32-NEXT:    call void @llvm.riscv.vsseg2.triscv_vec_tuple_nxv8i8_2t.i32(target("riscv_vec_tuple", <vscale x 8 x i8>, 2) [[TMP2]], ptr [[PTR:%.*]], i32 -1, i32 3)
; RV32-NEXT:    ret void
;
; RV64-LABEL: @store_factor2_vscale(
; RV64-NEXT:    [[TMP1:%.*]] = call target("riscv_vec_tuple", <vscale x 8 x i8>, 2) @llvm.riscv.vector.insert.triscv_vec_tuple_nxv8i8_2t.nxv8i8.i64(target("riscv_vec_tuple", <vscale x 8 x i8>, 2) poison, <vscale x 8 x i8> [[V0:%.*]], i64 0)
; RV64-NEXT:    [[TMP2:%.*]] = call target("riscv_vec_tuple", <vscale x 8 x i8>, 2) @llvm.riscv.vector.insert.triscv_vec_tuple_nxv8i8_2t.nxv8i8.i64(target("riscv_vec_tuple", <vscale x 8 x i8>, 2) [[TMP1]], <vscale x 8 x i8> [[V1:%.*]], i64 1)
; RV64-NEXT:    call void @llvm.riscv.vsseg2.triscv_vec_tuple_nxv8i8_2t.i64(target("riscv_vec_tuple", <vscale x 8 x i8>, 2) [[TMP2]], ptr [[PTR:%.*]], i64 -1, i64 3)
; RV64-NEXT:    ret void
;
