...
; GFX10-NEXT:  ; %bb.1:
; GFX10-NEXT:    s_load_dword s1, s[2:3], 0x24
; GFX10-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX11-NEXT:    v_dual_mov_b32 v2, s1 :: v_dual_mov_b32 v1, s4
...
; GFX90A-NEXT:  ; %bb.1:
; GFX90A-NEXT:    s_load_dwordx4 s[8:11], s[2:3], 0x34
; GFX90A-NEXT:    s_waitcnt lgkmcnt(0)
; GFX90A-NEXT:    s_bcnt1_i32_b64 s4, s[4:5]
; GFX90A-NEXT:    s_mul_i32 s4, s4, 5
...
; GFX9-FLATSCR-NEXT:  ; %bb.1:
; GFX9-FLATSCR-NEXT:    s_load_dwordx4 s[8:11], s[2:3], 0x34
; GFX9-FLATSCR-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9-FLATSCR-NEXT:    s_bcnt1_i32_b64 s4, s[4:5]
; GFX9-FLATSCR-NEXT:    s_mul_i32 s4, s4, 5
