...
; SI-NEXT:    s_waitcnt lgkmcnt(0)
; SI-NEXT:    s_load_dword s7, s[2:3], 0xd
...
; VI-NEXT:    s_waitcnt lgkmcnt(0)
; VI-NEXT:    s_load_dword s7, s[2:3], 0x34
...
; GFX9-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9-NEXT:    s_load_dword s7, s[2:3], 0x34
...
; VI-NEXT:    s_waitcnt lgkmcnt(0)
; VI-NEXT:    v_mad_i64_i32 v[0:1], s[2:3], s4, v0, 0
; VI-NEXT:    s_mov_b32 s3, 0xf000
; VI-NEXT:    s_mov_b32 s2, -1
; VI-NEXT:    s_nop 2
...
; GFX9-NEXT:    s_mov_b32 s2, -1
; GFX9-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9-NEXT:    s_mul_hi_i32 s5, s4, 0x50
...
; GFX10-NEXT:    s_waitcnt lgkmcnt(0)
; GFX10-NEXT:    s_mul_i32 s2, s4, 0x50
; GFX10-NEXT:    s_mul_hi_i32 s3, s4, 0x50
...
; GFX11-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-NEXT:    s_mul_i32 s2, s4, 0x50
; GFX11-NEXT:    s_mul_hi_i32 s3, s4, 0x50
...
; VI-NEXT:    v_mov_b32_e32 v0, 0x50
; VI-NEXT:    s_waitcnt lgkmcnt(0)
; VI-NEXT:    v_mad_u64_u32 v[0:1], s[2:3], s4, v0, 0
; VI-NEXT:    s_mov_b32 s3, 0xf000
; VI-NEXT:    s_mov_b32 s2, -1
; VI-NEXT:    s_nop 2
; VI-NEXT:    buffer_store_dwordx2 v[0:1], off, s[0:3], 0
...
; GFX9-NEXT:    s_mov_b32 s2, -1
; GFX9-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9-NEXT:    s_mul_hi_u32 s5, s4, 0x50
; GFX9-NEXT:    s_mulk_i32 s4, 0x50
; GFX9-NEXT:    v_mov_b32_e32 v0, s4
; GFX9-NEXT:    v_mov_b32_e32 v1, s5
; GFX9-NEXT:    buffer_store_dwordx2 v[0:1], off, s[0:3], 0
...
; GFX10-NEXT:    s_waitcnt lgkmcnt(0)
; GFX10-NEXT:    s_mul_i32 s2, s4, 0x50
; GFX10-NEXT:    s_mul_hi_u32 s3, s4, 0x50
; GFX10-NEXT:    v_mov_b32_e32 v0, s2
; GFX10-NEXT:    v_mov_b32_e32 v1, s3
; GFX10-NEXT:    s_mov_b32 s3, 0x31016000
; GFX10-NEXT:    s_mov_b32 s2, -1
...
; GFX11-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-NEXT:    s_mul_i32 s2, s4, 0x50
; GFX11-NEXT:    s_mul_hi_u32 s3, s4, 0x50
; GFX11-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX11-NEXT:    v_dual_mov_b32 v0, s2 :: v_dual_mov_b32 v1, s3
; GFX11-NEXT:    s_mov_b32 s3, 0x31016000
; GFX11-NEXT:    s_mov_b32 s2, -1
...
; GFX10-NEXT:    s_load_dword s4, s[2:3], 0x4c
; GFX10-NEXT:    s_load_dword s5, s[2:3], 0x70
; GFX10-NEXT:    s_load_dwordx2 s[0:1], s[2:3], 0x24
; GFX10-NEXT:    s_mov_b32 s3, 0x31016000
; GFX10-NEXT:    s_waitcnt lgkmcnt(0)
; GFX10-NEXT:    s_mul_i32 s2, s4, s5
; GFX10-NEXT:    v_mov_b32_e32 v0, s2
; GFX10-NEXT:    s_mov_b32 s2, -1
...
; GFX9:       ; %bb.0: ; %entry
; GFX9-NEXT:    s_load_dwordx4 s[4:7], s[2:3], 0x24
; GFX9-NEXT:    s_load_dwordx2 s[8:9], s[2:3], 0x34
; GFX9-NEXT:    s_mov_b32 s3, 0xf000
; GFX9-NEXT:    s_mov_b32 s2, -1
; GFX9-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9-NEXT:    s_mov_b32 s0, s4
...
; GFX10-NEXT:    s_mov_b32 s3, 0x31016000
; GFX10-NEXT:    s_waitcnt lgkmcnt(0)
; GFX10-NEXT:    s_mul_i32 s1, s6, s1
; GFX10-NEXT:    s_mul_hi_u32 s2, s6, s0
; GFX10-NEXT:    s_add_i32 s1, s2, s1
; GFX10-NEXT:    s_mul_i32 s2, s7, s0
; GFX10-NEXT:    s_mul_i32 s0, s6, s0
...
; SI-LABEL: s_mul_i128:
; SI:       ; %bb.0: ; %entry
; SI-NEXT:    s_load_dwordx4 s[4:7], s[2:3], 0x13
; SI-NEXT:    s_load_dwordx4 s[8:11], s[2:3], 0x1f
; SI-NEXT:    s_load_dwordx2 s[0:1], s[2:3], 0x9
; SI-NEXT:    s_mov_b32 s3, 0xf000
; SI-NEXT:    s_mov_b32 s2, -1
; SI-NEXT:    s_waitcnt lgkmcnt(0)
...
; VI-LABEL: s_mul_i128:
; VI:       ; %bb.0: ; %entry
; VI-NEXT:    s_load_dwordx4 s[4:7], s[2:3], 0x4c
; VI-NEXT:    s_load_dwordx4 s[8:11], s[2:3], 0x7c
; VI-NEXT:    s_load_dwordx2 s[0:1], s[2:3], 0x24
...
; GFX9:       ; %bb.0: ; %entry
; GFX9-NEXT:    s_load_dwordx4 s[4:7], s[2:3], 0x4c
; GFX9-NEXT:    s_load_dwordx4 s[8:11], s[2:3], 0x7c
; GFX9-NEXT:    s_load_dwordx2 s[0:1], s[2:3], 0x24
; GFX9-NEXT:    s_mov_b32 s3, 0xf000
; GFX9-NEXT:    s_mov_b32 s2, -1
; GFX9-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9-NEXT:    s_mul_i32 s7, s8, s7
; GFX9-NEXT:    s_mul_hi_u32 s12, s8, s6
; GFX9-NEXT:    s_add_i32 s7, s12, s7
; GFX9-NEXT:    s_mul_i32 s12, s9, s6
; GFX9-NEXT:    s_add_i32 s7, s7, s12
; GFX9-NEXT:    s_mul_i32 s12, s10, s5
; GFX9-NEXT:    s_mul_hi_u32 s13, s10, s4
; GFX9-NEXT:    s_add_i32 s12, s13, s12
; GFX9-NEXT:    s_mul_i32 s11, s11, s4
; GFX9-NEXT:    s_mul_i32 s6, s8, s6
; GFX9-NEXT:    s_add_i32 s12, s12, s11
; GFX9-NEXT:    s_mul_i32 s10, s10, s4
; GFX9-NEXT:    s_add_u32 s10, s10, s6
; GFX9-NEXT:    s_addc_u32 s11, s12, s7
; GFX9-NEXT:    s_mul_i32 s14, s5, s8
; GFX9-NEXT:    s_mul_hi_u32 s15, s4, s8
; GFX9-NEXT:    s_mul_hi_u32 s13, s5, s8
; GFX9-NEXT:    s_add_u32 s14, s14, s15
; GFX9-NEXT:    s_mul_i32 s7, s4, s9
...
; GFX9-NEXT:    s_addc_u32 s13, 0, 0
; GFX9-NEXT:    s_mul_hi_u32 s14, s5, s9
; GFX9-NEXT:    s_mul_i32 s5, s5, s9
; GFX9-NEXT:    s_add_u32 s5, s5, s12
; GFX9-NEXT:    s_mov_b32 s6, 0
; GFX9-NEXT:    s_addc_u32 s9, s14, s13
; GFX9-NEXT:    s_add_u32 s10, s5, s10
; GFX9-NEXT:    s_mul_i32 s4, s4, s8
; GFX9-NEXT:    s_mov_b32 s5, s6
; GFX9-NEXT:    s_addc_u32 s9, s9, s11
...
; GFX10-NEXT:    s_addc_u32 s7, s7, s2
...
; GFX10-NEXT:    s_add_u32 s13, s17, s2
; GFX10-NEXT:    s_addc_u32 s10, s16, 0
; GFX10-NEXT:    s_mul_i32 s2, s4, s8
...
; GFX11-NEXT:    s_addc_u32 s7, s7, s2
...
; GFX11-NEXT:    s_add_u32 s13, s17, s2
; GFX11-NEXT:    s_addc_u32 s10, s16, 0
; GFX11-NEXT:    s_mul_i32 s2, s4, s8
...
; GFX12:       ; %bb.0: ; %entry
; GFX12-NEXT:    s_clause 0x1
; GFX12-NEXT:    s_load_b128 s[4:7], s[2:3], 0x7c
; GFX12-NEXT:    s_load_b128 s[8:11], s[2:3], 0x4c
; GFX12-NEXT:    s_mov_b32 s13, 0
; GFX12-NEXT:    s_load_b64 s[0:1], s[2:3], 0x24
; GFX12-NEXT:    s_mov_b32 s15, s13
; GFX12-NEXT:    s_mov_b32 s3, s13
; GFX12-NEXT:    s_mov_b32 s17, s13
; GFX12-NEXT:    s_mov_b32 s19, s13
; GFX12-NEXT:    s_mov_b32 s24, s13
; GFX12-NEXT:    s_wait_kmcnt 0x0
...
; SI-LABEL: v_mul_i128:
; SI:       ; %bb.0: ; %entry
; SI-NEXT:    s_load_dwordx4 s[0:3], s[2:3], 0xb
; SI-NEXT:    s_mov_b32 s7, 0xf000
...
; VI-LABEL: v_mul_i128:
; VI:       ; %bb.0: ; %entry
; VI-NEXT:    s_load_dwordx4 s[0:3], s[2:3], 0x2c
...
; GFX12:       ; %bb.0: ; %entry
; GFX12-NEXT:    s_load_b128 s[0:3], s[2:3], 0x2c
