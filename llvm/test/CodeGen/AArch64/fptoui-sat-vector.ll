...
; CHECK-GI:       warning: Instruction selection used fallback path for test_unsigned_v1f128_v1i32
; CHECK-GI-NEXT:  warning: Instruction selection used fallback path for test_unsigned_v2f128_v2i32
; CHECK-GI-NEXT:  warning: Instruction selection used fallback path for test_unsigned_v3f128_v3i32
; CHECK-GI-NEXT:  warning: Instruction selection used fallback path for test_unsigned_v4f128_v4i32
; CHECK-GI-NEXT:  warning: Instruction selection used fallback path for test_unsigned_v2f32_v2i100
; CHECK-GI-NEXT:  warning: Instruction selection used fallback path for test_unsigned_v4f32_v4i50
; CHECK-GI-NEXT:  warning: Instruction selection used fallback path for test_unsigned_v4f32_v4i100
; CHECK-GI-NEXT:  warning: Instruction selection used fallback path for test_unsigned_v2f64_v2i100
; CHECK-GI-NEXT:  warning: Instruction selection used fallback path for test_unsigned_v4f16_v4i50
; CHECK-GI-NEXT:  warning: Instruction selection used fallback path for test_unsigned_v4f16_v4i100
...
; CHECK-SD-NEXT:    csinv x1, x9, xzr, le
...
; CHECK-SD-CVT-NEXT:    mov s3, v1.s[2]
; CHECK-SD-CVT-NEXT:    mov s4, v1.s[3]
; CHECK-SD-CVT-NEXT:    fcvtzu w9, s1
; CHECK-SD-CVT-NEXT:    fcvtzu w13, s0
; CHECK-SD-CVT-NEXT:    mov s1, v0.s[2]
; CHECK-SD-CVT-NEXT:    fcvtzu w8, s2
; CHECK-SD-CVT-NEXT:    mov s2, v0.s[1]
; CHECK-SD-CVT-NEXT:    fcvtzu w10, s3
; CHECK-SD-CVT-NEXT:    fcvtzu w11, s4
; CHECK-SD-CVT-NEXT:    fcvtzu w14, s1
; CHECK-SD-CVT-NEXT:    mov s0, v0.s[3]
; CHECK-SD-CVT-NEXT:    cmp w8, #1
; CHECK-SD-CVT-NEXT:    fcvtzu w12, s2
; CHECK-SD-CVT-NEXT:    csinc w8, w8, wzr, lo
; CHECK-SD-CVT-NEXT:    cmp w9, #1
; CHECK-SD-CVT-NEXT:    csinc w9, w9, wzr, lo
; CHECK-SD-CVT-NEXT:    cmp w10, #1
; CHECK-SD-CVT-NEXT:    csinc w10, w10, wzr, lo
; CHECK-SD-CVT-NEXT:    cmp w11, #1
; CHECK-SD-CVT-NEXT:    fmov s1, w9
; CHECK-SD-CVT-NEXT:    csinc w11, w11, wzr, lo
; CHECK-SD-CVT-NEXT:    cmp w12, #1
; CHECK-SD-CVT-NEXT:    csinc w12, w12, wzr, lo
; CHECK-SD-CVT-NEXT:    cmp w13, #1
; CHECK-SD-CVT-NEXT:    csinc w13, w13, wzr, lo
; CHECK-SD-CVT-NEXT:    mov v1.s[1], w8
; CHECK-SD-CVT-NEXT:    cmp w14, #1
; CHECK-SD-CVT-NEXT:    fmov s2, w13
; CHECK-SD-CVT-NEXT:    fcvtzu w8, s0
; CHECK-SD-CVT-NEXT:    csinc w9, w14, wzr, lo
; CHECK-SD-CVT-NEXT:    mov v2.s[1], w12
; CHECK-SD-CVT-NEXT:    mov v1.s[2], w10
; CHECK-SD-CVT-NEXT:    cmp w8, #1
; CHECK-SD-CVT-NEXT:    csinc w8, w8, wzr, lo
; CHECK-SD-CVT-NEXT:    mov v2.s[2], w9
...
; CHECK-SD-CVT-NEXT:    mov s3, v1.s[2]
; CHECK-SD-CVT-NEXT:    mov s4, v1.s[3]
; CHECK-SD-CVT-NEXT:    fcvtzu w10, s1
; CHECK-SD-CVT-NEXT:    fcvtzu w14, s0
; CHECK-SD-CVT-NEXT:    mov s1, v0.s[2]
; CHECK-SD-CVT-NEXT:    fcvtzu w9, s2
; CHECK-SD-CVT-NEXT:    mov s2, v0.s[1]
; CHECK-SD-CVT-NEXT:    fcvtzu w11, s3
; CHECK-SD-CVT-NEXT:    fcvtzu w12, s4
; CHECK-SD-CVT-NEXT:    fcvtzu w15, s1
; CHECK-SD-CVT-NEXT:    mov s0, v0.s[3]
; CHECK-SD-CVT-NEXT:    cmp w9, #255
; CHECK-SD-CVT-NEXT:    fcvtzu w13, s2
; CHECK-SD-CVT-NEXT:    csel w9, w9, w8, lo
; CHECK-SD-CVT-NEXT:    cmp w10, #255
; CHECK-SD-CVT-NEXT:    csel w10, w10, w8, lo
; CHECK-SD-CVT-NEXT:    cmp w11, #255
; CHECK-SD-CVT-NEXT:    csel w11, w11, w8, lo
; CHECK-SD-CVT-NEXT:    cmp w12, #255
; CHECK-SD-CVT-NEXT:    fmov s1, w10
; CHECK-SD-CVT-NEXT:    csel w12, w12, w8, lo
; CHECK-SD-CVT-NEXT:    cmp w13, #255
; CHECK-SD-CVT-NEXT:    csel w13, w13, w8, lo
; CHECK-SD-CVT-NEXT:    cmp w14, #255
; CHECK-SD-CVT-NEXT:    csel w14, w14, w8, lo
; CHECK-SD-CVT-NEXT:    mov v1.s[1], w9
; CHECK-SD-CVT-NEXT:    cmp w15, #255
; CHECK-SD-CVT-NEXT:    fmov s2, w14
; CHECK-SD-CVT-NEXT:    fcvtzu w9, s0
; CHECK-SD-CVT-NEXT:    csel w10, w15, w8, lo
; CHECK-SD-CVT-NEXT:    mov v2.s[1], w13
; CHECK-SD-CVT-NEXT:    mov v1.s[2], w11
; CHECK-SD-CVT-NEXT:    cmp w9, #255
; CHECK-SD-CVT-NEXT:    csel w8, w9, w8, lo
; CHECK-SD-CVT-NEXT:    mov v2.s[2], w10
; CHECK-SD-CVT-NEXT:    mov v1.s[3], w12
; CHECK-SD-CVT-NEXT:    mov v2.s[3], w8
; CHECK-SD-CVT-NEXT:    uzp1 v0.8h, v2.8h, v1.8h
; CHECK-SD-CVT-NEXT:    xtn v0.8b, v0.8h
; CHECK-SD-CVT-NEXT:    ret
...
; CHECK-SD-CVT-NEXT:    fcvtl2 v1.4s, v0.8h
; CHECK-SD-CVT-NEXT:    fcvtl v0.4s, v0.4h
; CHECK-SD-CVT-NEXT:    mov w8, #8191 // =0x1fff
; CHECK-SD-CVT-NEXT:    mov s2, v1.s[1]
; CHECK-SD-CVT-NEXT:    mov s3, v1.s[2]
; CHECK-SD-CVT-NEXT:    mov s4, v1.s[3]
; CHECK-SD-CVT-NEXT:    fcvtzu w10, s1
...
; CHECK-SD-CVT-NEXT:    fcvtl2 v1.4s, v0.8h
; CHECK-SD-CVT-NEXT:    fcvtl v0.4s, v0.4h
; CHECK-SD-CVT-NEXT:    mov w8, #65535 // =0xffff
; CHECK-SD-CVT-NEXT:    mov s2, v1.s[1]
; CHECK-SD-CVT-NEXT:    mov s3, v1.s[2]
; CHECK-SD-CVT-NEXT:    mov s4, v1.s[3]
; CHECK-SD-CVT-NEXT:    fcvtzu w10, s1
...
; CHECK-SD:       // %bb.0:
; CHECK-SD-NEXT:    movi v4.2d, #0x00ffff0000ffff
; CHECK-SD-NEXT:    fcvtzu v1.4s, v1.4s
; CHECK-SD-NEXT:    fcvtzu v0.4s, v0.4s
; CHECK-SD-NEXT:    fcvtzu v3.4s, v3.4s
; CHECK-SD-NEXT:    fcvtzu v2.4s, v2.4s
...
; CHECK-SD-CVT-NEXT:    mov s4, v2.s[2]
; CHECK-SD-CVT-NEXT:    mov s5, v2.s[3]
; CHECK-SD-CVT-NEXT:    fcvtzu w10, s2
; CHECK-SD-CVT-NEXT:    fcvtl2 v2.4s, v0.8h
; CHECK-SD-CVT-NEXT:    fcvtzu w13, s1
; CHECK-SD-CVT-NEXT:    fcvtl v0.4s, v0.4h
; CHECK-SD-CVT-NEXT:    fcvtzu w9, s3
; CHECK-SD-CVT-NEXT:    mov s3, v1.s[1]
; CHECK-SD-CVT-NEXT:    fcvtzu w11, s4
; CHECK-SD-CVT-NEXT:    mov s4, v1.s[2]
; CHECK-SD-CVT-NEXT:    fcvtzu w12, s5
; CHECK-SD-CVT-NEXT:    mov s1, v1.s[3]
; CHECK-SD-CVT-NEXT:    fcvtzu w18, s2
; CHECK-SD-CVT-NEXT:    fcvtzu w3, s0
; CHECK-SD-CVT-NEXT:    fcvtzu w14, s3
; CHECK-SD-CVT-NEXT:    cmp w9, #255
; CHECK-SD-CVT-NEXT:    mov s3, v2.s[1]
; CHECK-SD-CVT-NEXT:    csel w9, w9, w8, lo
; CHECK-SD-CVT-NEXT:    cmp w10, #255
; CHECK-SD-CVT-NEXT:    fcvtzu w15, s4
; CHECK-SD-CVT-NEXT:    csel w10, w10, w8, lo
; CHECK-SD-CVT-NEXT:    cmp w11, #255
; CHECK-SD-CVT-NEXT:    mov s4, v2.s[2]
; CHECK-SD-CVT-NEXT:    csel w11, w11, w8, lo
; CHECK-SD-CVT-NEXT:    cmp w12, #255
; CHECK-SD-CVT-NEXT:    fcvtzu w16, s1
; CHECK-SD-CVT-NEXT:    mov s1, v2.s[3]
; CHECK-SD-CVT-NEXT:    csel w12, w12, w8, lo
; CHECK-SD-CVT-NEXT:    cmp w14, #255
; CHECK-SD-CVT-NEXT:    fcvtzu w17, s3
; CHECK-SD-CVT-NEXT:    mov s3, v0.s[1]
; CHECK-SD-CVT-NEXT:    csel w14, w14, w8, lo
; CHECK-SD-CVT-NEXT:    cmp w13, #255
; CHECK-SD-CVT-NEXT:    fcvtzu w0, s4
; CHECK-SD-CVT-NEXT:    fmov s2, w10
; CHECK-SD-CVT-NEXT:    csel w13, w13, w8, lo
; CHECK-SD-CVT-NEXT:    cmp w15, #255
; CHECK-SD-CVT-NEXT:    csel w15, w15, w8, lo
; CHECK-SD-CVT-NEXT:    cmp w16, #255
; CHECK-SD-CVT-NEXT:    fcvtzu w1, s1
; CHECK-SD-CVT-NEXT:    csel w16, w16, w8, lo
; CHECK-SD-CVT-NEXT:    cmp w17, #255
; CHECK-SD-CVT-NEXT:    fcvtzu w2, s3
; CHECK-SD-CVT-NEXT:    csel w17, w17, w8, lo
; CHECK-SD-CVT-NEXT:    cmp w18, #255
; CHECK-SD-CVT-NEXT:    mov s1, v0.s[2]
; CHECK-SD-CVT-NEXT:    csel w18, w18, w8, lo
; CHECK-SD-CVT-NEXT:    cmp w0, #255
; CHECK-SD-CVT-NEXT:    mov v2.s[1], w9
; CHECK-SD-CVT-NEXT:    csel w0, w0, w8, lo
; CHECK-SD-CVT-NEXT:    cmp w1, #255
; CHECK-SD-CVT-NEXT:    fmov s3, w18
; CHECK-SD-CVT-NEXT:    csel w10, w1, w8, lo
; CHECK-SD-CVT-NEXT:    cmp w2, #255
; CHECK-SD-CVT-NEXT:    mov s0, v0.s[3]
; CHECK-SD-CVT-NEXT:    csel w9, w2, w8, lo
; CHECK-SD-CVT-NEXT:    cmp w3, #255
; CHECK-SD-CVT-NEXT:    fcvtzu w2, s1
; CHECK-SD-CVT-NEXT:    csel w1, w3, w8, lo
; CHECK-SD-CVT-NEXT:    fmov s1, w13
; CHECK-SD-CVT-NEXT:    mov v3.s[1], w17
; CHECK-SD-CVT-NEXT:    fmov s4, w1
; CHECK-SD-CVT-NEXT:    mov v2.s[2], w11
; CHECK-SD-CVT-NEXT:    mov v1.s[1], w14
; CHECK-SD-CVT-NEXT:    cmp w2, #255
; CHECK-SD-CVT-NEXT:    mov v4.s[1], w9
; CHECK-SD-CVT-NEXT:    fcvtzu w9, s0
; CHECK-SD-CVT-NEXT:    csel w11, w2, w8, lo
; CHECK-SD-CVT-NEXT:    mov v3.s[2], w0
; CHECK-SD-CVT-NEXT:    mov v2.s[3], w12
; CHECK-SD-CVT-NEXT:    mov v1.s[2], w15
; CHECK-SD-CVT-NEXT:    mov v4.s[2], w11
; CHECK-SD-CVT-NEXT:    cmp w9, #255
; CHECK-SD-CVT-NEXT:    csel w8, w9, w8, lo
; CHECK-SD-CVT-NEXT:    mov v3.s[3], w10
; CHECK-SD-CVT-NEXT:    mov v1.s[3], w16
...
; CHECK-SD-FP16:       // %bb.0:
; CHECK-SD-FP16-NEXT:    movi v2.2d, #0xff00ff00ff00ff
; CHECK-SD-FP16-NEXT:    fcvtzu v1.8h, v1.8h
; CHECK-SD-FP16-NEXT:    fcvtzu v0.8h, v0.8h
; CHECK-SD-FP16-NEXT:    umin v1.8h, v1.8h, v2.8h
; CHECK-SD-FP16-NEXT:    umin v0.8h, v0.8h, v2.8h
...
; CHECK-SD-CVT-NEXT:    mov s3, v0.s[1]
; CHECK-SD-CVT-NEXT:    fcvtzu w11, s4
; CHECK-SD-CVT-NEXT:    mov s4, v0.s[2]
; CHECK-SD-CVT-NEXT:    fcvtzu w12, s5
; CHECK-SD-CVT-NEXT:    mov s0, v0.s[3]
; CHECK-SD-CVT-NEXT:    fcvtzu w18, s2
; CHECK-SD-CVT-NEXT:    fcvtzu w3, s1
; CHECK-SD-CVT-NEXT:    fcvtzu w14, s3
; CHECK-SD-CVT-NEXT:    cmp w9, w8
; CHECK-SD-CVT-NEXT:    mov s3, v2.s[1]
; CHECK-SD-CVT-NEXT:    csel w9, w9, w8, lo
...
; CHECK-SD-CVT-NEXT:    csel w11, w11, w8, lo
; CHECK-SD-CVT-NEXT:    cmp w12, w8
; CHECK-SD-CVT-NEXT:    fcvtzu w16, s0
; CHECK-SD-CVT-NEXT:    mov s0, v2.s[3]
; CHECK-SD-CVT-NEXT:    csel w12, w12, w8, lo
; CHECK-SD-CVT-NEXT:    cmp w14, w8
; CHECK-SD-CVT-NEXT:    fcvtzu w17, s3
; CHECK-SD-CVT-NEXT:    mov s3, v1.s[1]
...
; CHECK-SD-CVT-NEXT:    fcvtzu w1, s0
; CHECK-SD-CVT-NEXT:    csel w16, w16, w8, lo
...
; CHECK-SD-CVT-NEXT:    fcvtzu w2, s0
; CHECK-SD-CVT-NEXT:    csel w1, w3, w8, lo
