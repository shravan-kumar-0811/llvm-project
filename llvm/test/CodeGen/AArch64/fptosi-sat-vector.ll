...
; RUN: llc < %s -mtriple=aarch64 | FileCheck %s --check-prefixes=CHECK,CHECK-SD,CHECK-SD-CVT,CHECK-CVT,CHECK-FP16
...
; CHECK-GI:       warning: Instruction selection used fallback path for test_signed_v1f128_v1i32
; CHECK-GI-NEXT:  warning: Instruction selection used fallback path for test_signed_v2f128_v2i32
; CHECK-GI-NEXT:  warning: Instruction selection used fallback path for test_signed_v3f128_v3i32
; CHECK-GI-NEXT:  warning: Instruction selection used fallback path for test_signed_v4f128_v4i32
; CHECK-GI-NEXT:  warning: Instruction selection used fallback path for test_signed_v2f32_v2i100
; CHECK-GI-NEXT:  warning: Instruction selection used fallback path for test_signed_v4f32_v4i50
; CHECK-GI-NEXT:  warning: Instruction selection used fallback path for test_signed_v4f32_v4i100
; CHECK-GI-NEXT:  warning: Instruction selection used fallback path for test_signed_v2f64_v2i100
; CHECK-GI-NEXT:  warning: Instruction selection used fallback path for test_signed_v4f16_v4i50
; CHECK-GI-NEXT:  warning: Instruction selection used fallback path for test_signed_v4f16_v4i100
...
; CHECK-SD-NEXT:    csel x8, x21, x1, lt
...
; CHECK-SD-NEXT:    csel x8, x22, x8, gt
...
; CHECK-SD-NEXT:    stp d9, d8, [sp, #40] // 16-byte Folded Spill
...
; CHECK-SD-NEXT:    mov x6, x23
; CHECK-SD-NEXT:    fcmp s0, s9
; CHECK-SD-NEXT:    mov x7, x24
...
; CHECK-SD-NEXT:    csel x8, x25, x1, lt
; CHECK-SD-NEXT:    csel x9, xzr, x0, lt
; CHECK-SD-NEXT:    fcmp s0, s10
; CHECK-SD-NEXT:    ldp x24, x23, [sp, #80] // 16-byte Folded Reload
; CHECK-SD-NEXT:    ldr d10, [sp, #32] // 8-byte Folded Reload
; CHECK-SD-NEXT:    ldp d9, d8, [sp, #40] // 16-byte Folded Reload
; CHECK-SD-NEXT:    csinv x9, x9, xzr, le
; CHECK-SD-NEXT:    csel x8, x26, x8, gt
; CHECK-SD-NEXT:    fcmp s0, s0
...
; CHECK-SD-CVT-NEXT:    fcvtl v0.4s, v0.4h
; CHECK-SD-CVT-NEXT:    mov s2, v1.s[1]
; CHECK-SD-CVT-NEXT:    fcvtzs w9, s1
; CHECK-SD-CVT-NEXT:    fcvtzs w13, s0
; CHECK-SD-CVT-NEXT:    fcvtzs w8, s2
; CHECK-SD-CVT-NEXT:    mov s2, v1.s[2]
; CHECK-SD-CVT-NEXT:    mov s1, v1.s[3]
; CHECK-SD-CVT-NEXT:    ands w8, w8, w8, asr #31
; CHECK-SD-CVT-NEXT:    fcvtzs w10, s2
; CHECK-SD-CVT-NEXT:    mov s2, v0.s[1]
; CHECK-SD-CVT-NEXT:    fcvtzs w11, s1
; CHECK-SD-CVT-NEXT:    mov s1, v0.s[2]
; CHECK-SD-CVT-NEXT:    mov s0, v0.s[3]
; CHECK-SD-CVT-NEXT:    csinv w8, w8, wzr, ge
; CHECK-SD-CVT-NEXT:    ands w9, w9, w9, asr #31
; CHECK-SD-CVT-NEXT:    csinv w9, w9, wzr, ge
; CHECK-SD-CVT-NEXT:    ands w10, w10, w10, asr #31
; CHECK-SD-CVT-NEXT:    fcvtzs w12, s2
; CHECK-SD-CVT-NEXT:    fcvtzs w14, s1
; CHECK-SD-CVT-NEXT:    fmov s1, w9
; CHECK-SD-CVT-NEXT:    fcvtzs w9, s0
; CHECK-SD-CVT-NEXT:    csinv w10, w10, wzr, ge
; CHECK-SD-CVT-NEXT:    ands w11, w11, w11, asr #31
; CHECK-SD-CVT-NEXT:    csinv w11, w11, wzr, ge
; CHECK-SD-CVT-NEXT:    ands w12, w12, w12, asr #31
; CHECK-SD-CVT-NEXT:    mov v1.s[1], w8
; CHECK-SD-CVT-NEXT:    csinv w12, w12, wzr, ge
; CHECK-SD-CVT-NEXT:    ands w13, w13, w13, asr #31
; CHECK-SD-CVT-NEXT:    csinv w13, w13, wzr, ge
; CHECK-SD-CVT-NEXT:    ands w8, w14, w14, asr #31
; CHECK-SD-CVT-NEXT:    mov v1.s[2], w10
; CHECK-SD-CVT-NEXT:    fmov s2, w13
; CHECK-SD-CVT-NEXT:    csinv w8, w8, wzr, ge
; CHECK-SD-CVT-NEXT:    mov v2.s[1], w12
; CHECK-SD-CVT-NEXT:    mov v1.s[3], w11
; CHECK-SD-CVT-NEXT:    mov v2.s[2], w8
; CHECK-SD-CVT-NEXT:    ands w8, w9, w9, asr #31
; CHECK-SD-CVT-NEXT:    csinv w8, w8, wzr, ge
; CHECK-SD-CVT-NEXT:    mov v2.s[3], w8
; CHECK-SD-CVT-NEXT:    uzp1 v0.8h, v2.8h, v1.8h
...
; CHECK-SD-CVT-NEXT:    fcvtl v0.4s, v0.4h
; CHECK-SD-CVT-NEXT:    mov w11, #-128 // =0xffffff80
; CHECK-SD-CVT-NEXT:    mov s2, v1.s[1]
; CHECK-SD-CVT-NEXT:    fcvtzs w10, s1
; CHECK-SD-CVT-NEXT:    fcvtzs w15, s0
; CHECK-SD-CVT-NEXT:    fcvtzs w9, s2
; CHECK-SD-CVT-NEXT:    mov s2, v1.s[2]
; CHECK-SD-CVT-NEXT:    mov s1, v1.s[3]
; CHECK-SD-CVT-NEXT:    cmp w9, #127
; CHECK-SD-CVT-NEXT:    fcvtzs w12, s2
; CHECK-SD-CVT-NEXT:    mov s2, v0.s[1]
; CHECK-SD-CVT-NEXT:    csel w9, w9, w8, lt
; CHECK-SD-CVT-NEXT:    fcvtzs w13, s1
; CHECK-SD-CVT-NEXT:    mov s1, v0.s[2]
; CHECK-SD-CVT-NEXT:    cmn w9, #128
; CHECK-SD-CVT-NEXT:    mov s0, v0.s[3]
; CHECK-SD-CVT-NEXT:    csel w9, w9, w11, gt
; CHECK-SD-CVT-NEXT:    cmp w10, #127
; CHECK-SD-CVT-NEXT:    csel w10, w10, w8, lt
; CHECK-SD-CVT-NEXT:    fcvtzs w14, s2
; CHECK-SD-CVT-NEXT:    cmn w10, #128
; CHECK-SD-CVT-NEXT:    fcvtzs w16, s1
; CHECK-SD-CVT-NEXT:    csel w10, w10, w11, gt
; CHECK-SD-CVT-NEXT:    cmp w12, #127
; CHECK-SD-CVT-NEXT:    csel w12, w12, w8, lt
; CHECK-SD-CVT-NEXT:    fmov s1, w10
; CHECK-SD-CVT-NEXT:    cmn w12, #128
; CHECK-SD-CVT-NEXT:    csel w12, w12, w11, gt
; CHECK-SD-CVT-NEXT:    cmp w13, #127
; CHECK-SD-CVT-NEXT:    csel w13, w13, w8, lt
; CHECK-SD-CVT-NEXT:    mov v1.s[1], w9
; CHECK-SD-CVT-NEXT:    fcvtzs w9, s0
; CHECK-SD-CVT-NEXT:    cmn w13, #128
; CHECK-SD-CVT-NEXT:    csel w13, w13, w11, gt
; CHECK-SD-CVT-NEXT:    cmp w14, #127
; CHECK-SD-CVT-NEXT:    csel w14, w14, w8, lt
; CHECK-SD-CVT-NEXT:    cmn w14, #128
; CHECK-SD-CVT-NEXT:    mov v1.s[2], w12
; CHECK-SD-CVT-NEXT:    csel w14, w14, w11, gt
; CHECK-SD-CVT-NEXT:    cmp w15, #127
; CHECK-SD-CVT-NEXT:    csel w15, w15, w8, lt
; CHECK-SD-CVT-NEXT:    cmn w15, #128
; CHECK-SD-CVT-NEXT:    csel w10, w15, w11, gt
; CHECK-SD-CVT-NEXT:    cmp w16, #127
; CHECK-SD-CVT-NEXT:    mov v1.s[3], w13
; CHECK-SD-CVT-NEXT:    fmov s2, w10
; CHECK-SD-CVT-NEXT:    csel w10, w16, w8, lt
; CHECK-SD-CVT-NEXT:    cmn w10, #128
; CHECK-SD-CVT-NEXT:    csel w10, w10, w11, gt
; CHECK-SD-CVT-NEXT:    cmp w9, #127
; CHECK-SD-CVT-NEXT:    mov v2.s[1], w14
; CHECK-SD-CVT-NEXT:    csel w8, w9, w8, lt
; CHECK-SD-CVT-NEXT:    cmn w8, #128
; CHECK-SD-CVT-NEXT:    csel w8, w8, w11, gt
; CHECK-SD-CVT-NEXT:    mov v2.s[2], w10
; CHECK-SD-CVT-NEXT:    mov v2.s[3], w8
; CHECK-SD-CVT-NEXT:    uzp1 v0.8h, v2.8h, v1.8h
; CHECK-SD-CVT-NEXT:    xtn v0.8b, v0.8h
; CHECK-SD-CVT-NEXT:    ret
...
; CHECK-SD-CVT-NEXT:    fcvtl v0.4s, v0.4h
; CHECK-SD-CVT-NEXT:    mov w11, #-4096 // =0xfffff000
; CHECK-SD-CVT-NEXT:    mov s2, v1.s[1]
; CHECK-SD-CVT-NEXT:    fcvtzs w10, s1
; CHECK-SD-CVT-NEXT:    fcvtzs w15, s0
; CHECK-SD-CVT-NEXT:    fcvtzs w9, s2
...
; CHECK-SD-CVT-NEXT:    fcvtzs w13, s1
; CHECK-SD-CVT-NEXT:    mov s1, v0.s[2]
; CHECK-SD-CVT-NEXT:    cmn w9, #1, lsl #12 // =4096
; CHECK-SD-CVT-NEXT:    mov s0, v0.s[3]
; CHECK-SD-CVT-NEXT:    csel w9, w9, w11, gt
; CHECK-SD-CVT-NEXT:    cmp w10, #4095
; CHECK-SD-CVT-NEXT:    csel w10, w10, w8, lt
; CHECK-SD-CVT-NEXT:    fcvtzs w14, s2
; CHECK-SD-CVT-NEXT:    cmn w10, #1, lsl #12 // =4096
; CHECK-SD-CVT-NEXT:    fcvtzs w16, s1
; CHECK-SD-CVT-NEXT:    csel w10, w10, w11, gt
; CHECK-SD-CVT-NEXT:    cmp w12, #4095
; CHECK-SD-CVT-NEXT:    csel w12, w12, w8, lt
; CHECK-SD-CVT-NEXT:    fmov s1, w10
; CHECK-SD-CVT-NEXT:    cmn w12, #1, lsl #12 // =4096
; CHECK-SD-CVT-NEXT:    csel w12, w12, w11, gt
; CHECK-SD-CVT-NEXT:    cmp w13, #4095
; CHECK-SD-CVT-NEXT:    csel w13, w13, w8, lt
; CHECK-SD-CVT-NEXT:    mov v1.s[1], w9
; CHECK-SD-CVT-NEXT:    fcvtzs w9, s0
; CHECK-SD-CVT-NEXT:    cmn w13, #1, lsl #12 // =4096
; CHECK-SD-CVT-NEXT:    csel w13, w13, w11, gt
; CHECK-SD-CVT-NEXT:    cmp w14, #4095
; CHECK-SD-CVT-NEXT:    csel w14, w14, w8, lt
; CHECK-SD-CVT-NEXT:    cmn w14, #1, lsl #12 // =4096
; CHECK-SD-CVT-NEXT:    mov v1.s[2], w12
; CHECK-SD-CVT-NEXT:    csel w14, w14, w11, gt
; CHECK-SD-CVT-NEXT:    cmp w15, #4095
; CHECK-SD-CVT-NEXT:    csel w15, w15, w8, lt
; CHECK-SD-CVT-NEXT:    cmn w15, #1, lsl #12 // =4096
; CHECK-SD-CVT-NEXT:    csel w10, w15, w11, gt
; CHECK-SD-CVT-NEXT:    cmp w16, #4095
; CHECK-SD-CVT-NEXT:    mov v1.s[3], w13
; CHECK-SD-CVT-NEXT:    fmov s2, w10
; CHECK-SD-CVT-NEXT:    csel w10, w16, w8, lt
; CHECK-SD-CVT-NEXT:    cmn w10, #1, lsl #12 // =4096
...
; CHECK-SD-CVT:       // %bb.0:
; CHECK-SD-CVT-NEXT:    fcvtl2 v1.4s, v0.8h
; CHECK-SD-CVT-NEXT:    mov w8, #32767 // =0x7fff
; CHECK-SD-CVT-NEXT:    fcvtl v0.4s, v0.4h
; CHECK-SD-CVT-NEXT:    mov w11, #-32768 // =0xffff8000
; CHECK-SD-CVT-NEXT:    mov s2, v1.s[1]
; CHECK-SD-CVT-NEXT:    fcvtzs w10, s1
; CHECK-SD-CVT-NEXT:    fcvtzs w15, s0
; CHECK-SD-CVT-NEXT:    fcvtzs w9, s2
; CHECK-SD-CVT-NEXT:    mov s2, v1.s[2]
; CHECK-SD-CVT-NEXT:    mov s1, v1.s[3]
; CHECK-SD-CVT-NEXT:    cmp w9, w8
; CHECK-SD-CVT-NEXT:    fcvtzs w12, s2
; CHECK-SD-CVT-NEXT:    mov s2, v0.s[1]
; CHECK-SD-CVT-NEXT:    csel w9, w9, w8, lt
; CHECK-SD-CVT-NEXT:    fcvtzs w13, s1
; CHECK-SD-CVT-NEXT:    mov s1, v0.s[2]
; CHECK-SD-CVT-NEXT:    cmn w9, #8, lsl #12 // =32768
; CHECK-SD-CVT-NEXT:    mov s0, v0.s[3]
; CHECK-SD-CVT-NEXT:    csel w9, w9, w11, gt
; CHECK-SD-CVT-NEXT:    cmp w10, w8
; CHECK-SD-CVT-NEXT:    csel w10, w10, w8, lt
; CHECK-SD-CVT-NEXT:    fcvtzs w14, s2
; CHECK-SD-CVT-NEXT:    cmn w10, #8, lsl #12 // =32768
; CHECK-SD-CVT-NEXT:    fcvtzs w16, s1
; CHECK-SD-CVT-NEXT:    csel w10, w10, w11, gt
; CHECK-SD-CVT-NEXT:    cmp w12, w8
; CHECK-SD-CVT-NEXT:    csel w12, w12, w8, lt
; CHECK-SD-CVT-NEXT:    fmov s1, w10
; CHECK-SD-CVT-NEXT:    cmn w12, #8, lsl #12 // =32768
; CHECK-SD-CVT-NEXT:    csel w12, w12, w11, gt
; CHECK-SD-CVT-NEXT:    cmp w13, w8
; CHECK-SD-CVT-NEXT:    csel w13, w13, w8, lt
; CHECK-SD-CVT-NEXT:    mov v1.s[1], w9
; CHECK-SD-CVT-NEXT:    fcvtzs w9, s0
; CHECK-SD-CVT-NEXT:    cmn w13, #8, lsl #12 // =32768
; CHECK-SD-CVT-NEXT:    csel w13, w13, w11, gt
; CHECK-SD-CVT-NEXT:    cmp w14, w8
; CHECK-SD-CVT-NEXT:    csel w14, w14, w8, lt
; CHECK-SD-CVT-NEXT:    cmn w14, #8, lsl #12 // =32768
; CHECK-SD-CVT-NEXT:    mov v1.s[2], w12
; CHECK-SD-CVT-NEXT:    csel w14, w14, w11, gt
; CHECK-SD-CVT-NEXT:    cmp w15, w8
; CHECK-SD-CVT-NEXT:    csel w15, w15, w8, lt
; CHECK-SD-CVT-NEXT:    cmn w15, #8, lsl #12 // =32768
; CHECK-SD-CVT-NEXT:    csel w10, w15, w11, gt
; CHECK-SD-CVT-NEXT:    cmp w16, w8
; CHECK-SD-CVT-NEXT:    mov v1.s[3], w13
; CHECK-SD-CVT-NEXT:    fmov s2, w10
; CHECK-SD-CVT-NEXT:    csel w10, w16, w8, lt
; CHECK-SD-CVT-NEXT:    cmn w10, #8, lsl #12 // =32768
...
; CHECK-SD-CVT:       // %bb.0:
; CHECK-SD-CVT-NEXT:    fcvtl2 v2.4s, v1.8h
; CHECK-SD-CVT-NEXT:    mov w8, #127 // =0x7f
; CHECK-SD-CVT-NEXT:    fcvtl v1.4s, v1.4h
; CHECK-SD-CVT-NEXT:    mov s3, v2.s[1]
; CHECK-SD-CVT-NEXT:    fcvtzs w10, s2
; CHECK-SD-CVT-NEXT:    fcvtzs w16, s1
; CHECK-SD-CVT-NEXT:    fcvtzs w9, s3
; CHECK-SD-CVT-NEXT:    mov s3, v2.s[2]
; CHECK-SD-CVT-NEXT:    mov s2, v2.s[3]
; CHECK-SD-CVT-NEXT:    cmp w9, #127
; CHECK-SD-CVT-NEXT:    fcvtzs w12, s3
; CHECK-SD-CVT-NEXT:    mov s3, v1.s[1]
; CHECK-SD-CVT-NEXT:    csel w11, w9, w8, lt
; CHECK-SD-CVT-NEXT:    mov w9, #-128 // =0xffffff80
; CHECK-SD-CVT-NEXT:    fcvtzs w14, s2
; CHECK-SD-CVT-NEXT:    cmn w11, #128
; CHECK-SD-CVT-NEXT:    mov s2, v1.s[2]
; CHECK-SD-CVT-NEXT:    mov s1, v1.s[3]
; CHECK-SD-CVT-NEXT:    csel w11, w11, w9, gt
; CHECK-SD-CVT-NEXT:    cmp w10, #127
; CHECK-SD-CVT-NEXT:    csel w10, w10, w8, lt
; CHECK-SD-CVT-NEXT:    fcvtzs w15, s3
; CHECK-SD-CVT-NEXT:    fcvtl2 v3.4s, v0.8h
; CHECK-SD-CVT-NEXT:    cmn w10, #128
; CHECK-SD-CVT-NEXT:    fcvtl v0.4s, v0.4h
; CHECK-SD-CVT-NEXT:    csel w13, w10, w9, gt
; CHECK-SD-CVT-NEXT:    cmp w12, #127
; CHECK-SD-CVT-NEXT:    fcvtzs w17, s1
; CHECK-SD-CVT-NEXT:    csel w10, w12, w8, lt
; CHECK-SD-CVT-NEXT:    cmn w10, #128
; CHECK-SD-CVT-NEXT:    mov s1, v3.s[2]
; CHECK-SD-CVT-NEXT:    fcvtzs w0, s3
; CHECK-SD-CVT-NEXT:    csel w10, w10, w9, gt
; CHECK-SD-CVT-NEXT:    cmp w14, #127
; CHECK-SD-CVT-NEXT:    fcvtzs w4, s0
; CHECK-SD-CVT-NEXT:    csel w12, w14, w8, lt
; CHECK-SD-CVT-NEXT:    cmn w12, #128
; CHECK-SD-CVT-NEXT:    csel w12, w12, w9, gt
; CHECK-SD-CVT-NEXT:    cmp w15, #127
; CHECK-SD-CVT-NEXT:    fcvtzs w1, s1
; CHECK-SD-CVT-NEXT:    csel w14, w15, w8, lt
; CHECK-SD-CVT-NEXT:    fcvtzs w15, s2
; CHECK-SD-CVT-NEXT:    mov s2, v3.s[1]
; CHECK-SD-CVT-NEXT:    cmn w14, #128
; CHECK-SD-CVT-NEXT:    mov s1, v0.s[1]
; CHECK-SD-CVT-NEXT:    csel w14, w14, w9, gt
; CHECK-SD-CVT-NEXT:    cmp w16, #127
; CHECK-SD-CVT-NEXT:    csel w16, w16, w8, lt
; CHECK-SD-CVT-NEXT:    cmn w16, #128
; CHECK-SD-CVT-NEXT:    fcvtzs w18, s2
; CHECK-SD-CVT-NEXT:    mov s2, v3.s[3]
; CHECK-SD-CVT-NEXT:    csel w16, w16, w9, gt
; CHECK-SD-CVT-NEXT:    cmp w15, #127
; CHECK-SD-CVT-NEXT:    fcvtzs w3, s1
; CHECK-SD-CVT-NEXT:    csel w15, w15, w8, lt
; CHECK-SD-CVT-NEXT:    mov s1, v0.s[2]
; CHECK-SD-CVT-NEXT:    mov s0, v0.s[3]
; CHECK-SD-CVT-NEXT:    cmn w15, #128
; CHECK-SD-CVT-NEXT:    csel w15, w15, w9, gt
; CHECK-SD-CVT-NEXT:    cmp w17, #127
; CHECK-SD-CVT-NEXT:    fcvtzs w2, s2
; CHECK-SD-CVT-NEXT:    csel w17, w17, w8, lt
; CHECK-SD-CVT-NEXT:    fmov s2, w13
; CHECK-SD-CVT-NEXT:    cmn w17, #128
; CHECK-SD-CVT-NEXT:    csel w17, w17, w9, gt
; CHECK-SD-CVT-NEXT:    cmp w18, #127
; CHECK-SD-CVT-NEXT:    csel w18, w18, w8, lt
; CHECK-SD-CVT-NEXT:    mov v2.s[1], w11
; CHECK-SD-CVT-NEXT:    cmn w18, #128
; CHECK-SD-CVT-NEXT:    csel w18, w18, w9, gt
; CHECK-SD-CVT-NEXT:    cmp w0, #127
; CHECK-SD-CVT-NEXT:    csel w0, w0, w8, lt
; CHECK-SD-CVT-NEXT:    cmn w0, #128
; CHECK-SD-CVT-NEXT:    mov v2.s[2], w10
; CHECK-SD-CVT-NEXT:    csel w0, w0, w9, gt
; CHECK-SD-CVT-NEXT:    cmp w1, #127
; CHECK-SD-CVT-NEXT:    csel w1, w1, w8, lt
; CHECK-SD-CVT-NEXT:    fmov s3, w0
; CHECK-SD-CVT-NEXT:    cmn w1, #128
; CHECK-SD-CVT-NEXT:    csel w1, w1, w9, gt
; CHECK-SD-CVT-NEXT:    cmp w2, #127
; CHECK-SD-CVT-NEXT:    mov v2.s[3], w12
; CHECK-SD-CVT-NEXT:    csel w2, w2, w8, lt
; CHECK-SD-CVT-NEXT:    mov v3.s[1], w18
; CHECK-SD-CVT-NEXT:    cmn w2, #128
; CHECK-SD-CVT-NEXT:    csel w2, w2, w9, gt
; CHECK-SD-CVT-NEXT:    cmp w3, #127
; CHECK-SD-CVT-NEXT:    csel w3, w3, w8, lt
; CHECK-SD-CVT-NEXT:    cmn w3, #128
; CHECK-SD-CVT-NEXT:    mov v3.s[2], w1
; CHECK-SD-CVT-NEXT:    csel w13, w3, w9, gt
; CHECK-SD-CVT-NEXT:    cmp w4, #127
; CHECK-SD-CVT-NEXT:    csel w3, w4, w8, lt
; CHECK-SD-CVT-NEXT:    fcvtzs w4, s1
; CHECK-SD-CVT-NEXT:    fmov s1, w16
; CHECK-SD-CVT-NEXT:    cmn w3, #128
; CHECK-SD-CVT-NEXT:    csel w11, w3, w9, gt
; CHECK-SD-CVT-NEXT:    mov v3.s[3], w2
; CHECK-SD-CVT-NEXT:    fmov s4, w11
; CHECK-SD-CVT-NEXT:    mov v1.s[1], w14
; CHECK-SD-CVT-NEXT:    fcvtzs w11, s0
; CHECK-SD-CVT-NEXT:    cmp w4, #127
; CHECK-SD-CVT-NEXT:    mov v4.s[1], w13
; CHECK-SD-CVT-NEXT:    csel w13, w4, w8, lt
; CHECK-SD-CVT-NEXT:    cmn w13, #128
; CHECK-SD-CVT-NEXT:    mov v1.s[2], w15
; CHECK-SD-CVT-NEXT:    csel w10, w13, w9, gt
; CHECK-SD-CVT-NEXT:    cmp w11, #127
; CHECK-SD-CVT-NEXT:    csel w8, w11, w8, lt
; CHECK-SD-CVT-NEXT:    mov v4.s[2], w10
; CHECK-SD-CVT-NEXT:    cmn w8, #128
; CHECK-SD-CVT-NEXT:    csel w8, w8, w9, gt
; CHECK-SD-CVT-NEXT:    mov v1.s[3], w17
; CHECK-SD-CVT-NEXT:    mov v4.s[3], w8
; CHECK-SD-CVT-NEXT:    uzp1 v0.8h, v1.8h, v2.8h
; CHECK-SD-CVT-NEXT:    uzp1 v1.8h, v4.8h, v3.8h
; CHECK-SD-CVT-NEXT:    uzp1 v0.16b, v1.16b, v0.16b
; CHECK-SD-CVT-NEXT:    ret
;
...
; CHECK-SD-CVT-NEXT:    mov s3, v2.s[1]
; CHECK-SD-CVT-NEXT:    fcvtzs w10, s2
; CHECK-SD-CVT-NEXT:    fcvtzs w16, s0
; CHECK-SD-CVT-NEXT:    fcvtzs w9, s3
; CHECK-SD-CVT-NEXT:    mov s3, v2.s[2]
; CHECK-SD-CVT-NEXT:    mov s2, v2.s[3]
; CHECK-SD-CVT-NEXT:    cmp w9, w8
; CHECK-SD-CVT-NEXT:    fcvtzs w12, s3
; CHECK-SD-CVT-NEXT:    mov s3, v0.s[1]
; CHECK-SD-CVT-NEXT:    csel w11, w9, w8, lt
; CHECK-SD-CVT-NEXT:    mov w9, #-32768 // =0xffff8000
; CHECK-SD-CVT-NEXT:    fcvtzs w14, s2
; CHECK-SD-CVT-NEXT:    cmn w11, #8, lsl #12 // =32768
; CHECK-SD-CVT-NEXT:    mov s2, v0.s[2]
; CHECK-SD-CVT-NEXT:    mov s0, v0.s[3]
; CHECK-SD-CVT-NEXT:    csel w11, w11, w9, gt
; CHECK-SD-CVT-NEXT:    cmp w10, w8
; CHECK-SD-CVT-NEXT:    csel w10, w10, w8, lt
...
; CHECK-SD-CVT-NEXT:    csel w13, w10, w9, gt
; CHECK-SD-CVT-NEXT:    cmp w12, w8
; CHECK-SD-CVT-NEXT:    fcvtzs w17, s0
; CHECK-SD-CVT-NEXT:    csel w10, w12, w8, lt
; CHECK-SD-CVT-NEXT:    cmn w10, #8, lsl #12 // =32768
; CHECK-SD-CVT-NEXT:    mov s0, v3.s[2]
; CHECK-SD-CVT-NEXT:    fcvtzs w0, s3
; CHECK-SD-CVT-NEXT:    csel w10, w10, w9, gt
; CHECK-SD-CVT-NEXT:    cmp w14, w8
; CHECK-SD-CVT-NEXT:    fcvtzs w4, s1
...
; CHECK-SD-CVT-NEXT:    csel w12, w12, w9, gt
; CHECK-SD-CVT-NEXT:    cmp w15, w8
; CHECK-SD-CVT-NEXT:    fcvtzs w1, s0
; CHECK-SD-CVT-NEXT:    csel w14, w15, w8, lt
; CHECK-SD-CVT-NEXT:    fcvtzs w15, s2
; CHECK-SD-CVT-NEXT:    mov s2, v3.s[1]
; CHECK-SD-CVT-NEXT:    cmn w14, #8, lsl #12 // =32768
; CHECK-SD-CVT-NEXT:    mov s0, v1.s[1]
; CHECK-SD-CVT-NEXT:    csel w14, w14, w9, gt
; CHECK-SD-CVT-NEXT:    cmp w16, w8
; CHECK-SD-CVT-NEXT:    csel w16, w16, w8, lt
; CHECK-SD-CVT-NEXT:    cmn w16, #8, lsl #12 // =32768
; CHECK-SD-CVT-NEXT:    fcvtzs w18, s2
; CHECK-SD-CVT-NEXT:    mov s2, v3.s[3]
; CHECK-SD-CVT-NEXT:    csel w16, w16, w9, gt
; CHECK-SD-CVT-NEXT:    cmp w15, w8
; CHECK-SD-CVT-NEXT:    fcvtzs w3, s0
; CHECK-SD-CVT-NEXT:    csel w15, w15, w8, lt
; CHECK-SD-CVT-NEXT:    mov s0, v1.s[2]
; CHECK-SD-CVT-NEXT:    cmn w15, #8, lsl #12 // =32768
; CHECK-SD-CVT-NEXT:    csel w15, w15, w9, gt
; CHECK-SD-CVT-NEXT:    cmp w17, w8
; CHECK-SD-CVT-NEXT:    fcvtzs w2, s2
; CHECK-SD-CVT-NEXT:    csel w17, w17, w8, lt
; CHECK-SD-CVT-NEXT:    fmov s2, w13
; CHECK-SD-CVT-NEXT:    cmn w17, #8, lsl #12 // =32768
; CHECK-SD-CVT-NEXT:    csel w17, w17, w9, gt
; CHECK-SD-CVT-NEXT:    cmp w18, w8
; CHECK-SD-CVT-NEXT:    csel w18, w18, w8, lt
; CHECK-SD-CVT-NEXT:    mov v2.s[1], w11
; CHECK-SD-CVT-NEXT:    cmn w18, #8, lsl #12 // =32768
; CHECK-SD-CVT-NEXT:    csel w18, w18, w9, gt
; CHECK-SD-CVT-NEXT:    cmp w0, w8
; CHECK-SD-CVT-NEXT:    csel w0, w0, w8, lt
; CHECK-SD-CVT-NEXT:    cmn w0, #8, lsl #12 // =32768
; CHECK-SD-CVT-NEXT:    mov v2.s[2], w10
; CHECK-SD-CVT-NEXT:    csel w0, w0, w9, gt
; CHECK-SD-CVT-NEXT:    cmp w1, w8
; CHECK-SD-CVT-NEXT:    csel w1, w1, w8, lt
; CHECK-SD-CVT-NEXT:    fmov s3, w0
; CHECK-SD-CVT-NEXT:    cmn w1, #8, lsl #12 // =32768
; CHECK-SD-CVT-NEXT:    csel w1, w1, w9, gt
; CHECK-SD-CVT-NEXT:    cmp w2, w8
; CHECK-SD-CVT-NEXT:    mov v2.s[3], w12
; CHECK-SD-CVT-NEXT:    csel w2, w2, w8, lt
; CHECK-SD-CVT-NEXT:    mov v3.s[1], w18
; CHECK-SD-CVT-NEXT:    cmn w2, #8, lsl #12 // =32768
; CHECK-SD-CVT-NEXT:    csel w2, w2, w9, gt
; CHECK-SD-CVT-NEXT:    cmp w3, w8
; CHECK-SD-CVT-NEXT:    csel w3, w3, w8, lt
; CHECK-SD-CVT-NEXT:    cmn w3, #8, lsl #12 // =32768
; CHECK-SD-CVT-NEXT:    mov v3.s[2], w1
; CHECK-SD-CVT-NEXT:    csel w13, w3, w9, gt
; CHECK-SD-CVT-NEXT:    cmp w4, w8
; CHECK-SD-CVT-NEXT:    csel w3, w4, w8, lt
; CHECK-SD-CVT-NEXT:    fcvtzs w4, s0
; CHECK-SD-CVT-NEXT:    mov s0, v1.s[3]
; CHECK-SD-CVT-NEXT:    cmn w3, #8, lsl #12 // =32768
; CHECK-SD-CVT-NEXT:    fmov s1, w16
; CHECK-SD-CVT-NEXT:    csel w11, w3, w9, gt
; CHECK-SD-CVT-NEXT:    mov v3.s[3], w2
