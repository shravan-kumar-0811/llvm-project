...
declare {target("riscv_vec_tuple", <vscale x 8 x i8>, 2), i64} @llvm.riscv.vlseg2ff.mask.triscv_vec_tuple_nxv8i8_2t(target("riscv_vec_tuple", <vscale x 8 x i8>, 2), ptr, <vscale x 8 x i1>, i64, i64, i64)
...
entry:
  ...
  %1 = extractvalue {target("riscv_vec_tuple", <vscale x 8 x i8>, 2), i64} %0, 1
  ret i64 %1
}

define i64 @test_vlseg2ff_nxv8i8_tu(target("riscv_vec_tuple", <vscale x 8 x i8>, 2) %val, ptr %base, i64 %vl, ptr %outvl) {
  ...
  ; CHECK-NEXT:   PseudoRET implicit $x10
entry:
  %0 = tail call {target("riscv_vec_tuple", <vscale x 8 x i8>, 2), i64} @llvm.riscv.vlseg2ff.triscv_vec_tuple_nxv8i8_2t(target("riscv_vec_tuple", <vscale x 8 x i8>, 2) %val, ptr %base, i64 %vl, i64 3)
  %1 = extractvalue {target("riscv_vec_tuple", <vscale x 8 x i8>, 2), i64} %0, 1
  ret i64 %1
}

define i64 @test_vlseg2ff_nxv8i8_mask(target("riscv_vec_tuple", <vscale x 8 x i8>, 2) %val, ptr %base, <vscale x 8 x i1> %mask, i64 %vl, ptr %outvl) {
  ...
  ; CHECK-NEXT:   PseudoRET implicit $x10
entry:
  %0 = tail call {target("riscv_vec_tuple", <vscale x 8 x i8>, 2), i64} @llvm.riscv.vlseg2ff.mask.triscv_vec_tuple_nxv8i8_2t(target("riscv_vec_tuple", <vscale x 8 x i8>, 2) %val, ptr %base, <vscale x 8 x i1> %mask, i64 %vl, i64 0, i64 3)
  %1 = extractvalue {target("riscv_vec_tuple", <vscale x 8 x i8>, 2), i64} %0, 1
  ret i64 %1
}
